using NetworkCodeAuthentication.ViewModels;
using NetworkCodeAuthentication.Views;
using System;
...
namespace NetworkCodeAuthentication.Services 
{
    public class NavigationService 
    {
        ...
        {
            await NavigateToAsync<StartUpViewModel>();
        }
        ...
        {
            mappings.Add(typeof(StartUpViewModel), typeof(StartUpView));
            mappings.Add(typeof(ValidationViewModel), typeof(ValidationView));
